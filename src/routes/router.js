...
import Crawler from '../components/crawler/crawlerList';
import AddCrawler from '../components/crawler/addCrawler';
import CrawlerTaskList from '../components/crawler/crawlerTaskList';
import RunCrawlerInstance from '../components/crawler/runCrawlerInstance';
import CrawlerDetail from '../components/crawler/showCrawlerDetail';
import InterfaceList from '../components/interface/interfaceList';
import InterfaceCallList from '../components/interface/interfaceCallList';
      ...
      <Router history={hashHistory}>
        <Route path={'/'} components={Page}>
          ...
          <Route path={'app'} component={App}>
            ...
            <Route path={'crawler'}>
              <Route path={'crawlerList'} component={Crawler} />
              <Route path={'addCrawler'} component={AddCrawler} />
              <Route path={'crawlerTaskList'} component={CrawlerTaskList} />
              <Route path={'crawlerInstance'} component={RunCrawlerInstance} />
              <Route path={'crawlerDetail'} component={CrawlerDetail} />
            </Route>
            <Route path={'interface'}>
              <Route path={'interfaceList'} component={InterfaceList} />
              <Route path={'interfaceCallList'} component={InterfaceCallList} />
            </Route>
            <Route path={'form'}>
