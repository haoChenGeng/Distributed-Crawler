...
class TabsCustom extends Component {
    ...
    componentDidMount() {
        console.dir(this.props.location.state.first);
        console.dir(this.props.location.state.second);
    }
    callback = (key) => {
        console.log(key);
    };
    ...
    render() {
        ...
        return (
            <div className="gutter-example button-demo">
                {/* <BreadcrumbCustom first={this.props.location.state.first} second={this.props.location.state.second} /> */}
                <Row gutter={16}>
